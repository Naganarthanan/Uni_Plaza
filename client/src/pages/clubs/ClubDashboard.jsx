...
import { productAdsAPI, eventAdsAPI, otherAdsAPI } from './services/api.jsx';
import EventAds from './EventAds.jsx';
import ProductAds from './ProductAds.jsx';
import OtherAds from './OtherAds.jsx';
import styles from './ClubDashboard.module.css';

const ClubDashboard = ({ currentClub, onLogout }) => {
        ...
        <div className={styles.headerLeft}>
          ...
          {currentClub && (
            <p className={styles.clubInfo}>
              Welcome, <strong>{currentClub.clubName || currentClub.email}</strong>
            </p>
          )}
        </div>
